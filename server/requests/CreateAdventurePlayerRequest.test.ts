...
import { CreateAdventurePlayerRequest } from './CreateAdventurePlayerRequest';

describe('CreateAdventurePlayerRequest', () => {
  describe('constructor', () => {
    it('should construct', () => {
      const subject = new CreateAdventurePlayerRequest(
        10,
        '1',
        'Character Name',
        '2',
