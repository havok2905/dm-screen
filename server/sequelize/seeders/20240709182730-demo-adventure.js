...
`
    ...
    await queryInterface.bulkInsert('AdventureCreatures', [
      {
...
`
    ...
    await queryInterface.bulkInsert('AdventureHandouts', [
      {
    ...
    await queryInterface.bulkInsert('AdventureItems', [
      {
...
**Weight:** 1`
  ...
  async down (queryInterface, Sequelize) {
    ...
    await queryInterface.bulkDelete('AdventureCreatures', null, {});
    await queryInterface.bulkDelete('AdventureHandouts', null, {});
    await queryInterface.bulkDelete('AdventureItems', null, {});
  }
};
